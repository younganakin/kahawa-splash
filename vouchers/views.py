...
def generate_codes(request):
    ...
    voucher_params_1 = {"numbers": 3}
    voucher_params_2 = {"numbers": 3}
    voucher_params_3 = {"numbers": 3}
    voucher_params_4 = {"numbers": 3}
    voucher_params_5 = {"numbers": 3}
    voucher_params_6 = {"numbers": 3}
    voucher_params_7 = {"numbers": 3}
    voucher_params_8 = {"numbers": 3}
    voucher_params_9 = {"numbers": 3}
